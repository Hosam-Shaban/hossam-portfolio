  ...
  return (
    <div className="min-h-screen bg-gray-50 p-8">
      <div className="max-w-5xl mx-auto space-y-8">
        ...
        >
          <h1 className="text-4xl font-bold text-gray-800">Hossam Shaban</h1>
        ...
        <Card className="shadow-lg">
          <CardContent className="p-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              <div className="bg-gray-200 h-40 rounded-xl flex items-center justify-center">Catalog Design</div>
              <div className="bg-gray-200 h-40 rounded-xl flex items-center justify-center">Product Graphics</div>
              <div className="bg-gray-200 h-40 rounded-xl flex items-center justify-center">Promo Video</div>
            </div>
          </CardContent>
        </Card>
        ...
        <Card className="shadow-lg">
          <CardContent className="p-6 text-center space-y-3">
            ...
            <div className="flex justify-center gap-4 mt-4">
              ...
              <Button variant="outline" asChild>
                <a href="https://www.linkedin.com/in/hossam-shaban-a5005115a" target="_blank"><Linkedin className="mr-2 h-4 w-4" /> LinkedIn</a>
              </Button>
              <Button variant="outline" asChild>
                <a href="https://hossam-portfolio.com" target="_blank"><Globe className="mr-2 h-4 w-4" /> Portfolio Website</a>
              </Button>
            </div>
          </CardContent>
        </Card>
